...
from .base import AbstractBatchSystem


class Lsf(AbstractBatchSystem):  # pragma: no cover

    def submit_analyses(self, app, command_tuples):
    ...
    @staticmethod
    def submit_array(
            commands, requirements, jobname, extra_args, throttle_by):
        """
